...
def ocr():
    ...
    image_path=r"D:\OneDrive\Pictures\Saved Pictures\gd10.jpg"
...
def pose_estd():
    ...
    cap = cv2.VideoCapture(r'C:\Users\SHALIN DASHORA\Downloads\videoplayback.mp4')
    while cap.isOpened():
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if(profanity.contains_profanity(query)):
             print("Query contains bad word/s,Thefore I am exiting.")
             exit()
        ...
        elif ("pose" in query) or ('estimation' in query):
           pose_estd()
        elif ("ocr"in query) or('text reader' in query):
            print("The text in file is:\n")
            ocr()
